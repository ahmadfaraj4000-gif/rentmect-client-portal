...
function App() {
  ...
  const [adminBookingHandoff, setAdminBookingHandoff] = useState(null);
  const [adminBookingRentalId, setAdminBookingRentalId] = useState('');
  const [adminBookingClaimed, setAdminBookingClaimed] = useState(false);
